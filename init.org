...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (use-package aidermacs
    ...
    (setq aidermacs-default-model "openai/lbl/cborg-deepthought")
    ...
    (add-to-list 'aidermacs-extra-args "--editor-edit-format=editor-diff"))
  ...
  (use-package gptel
    ...
    (setq gptel-backend (gptel-make-openai "cborg"
  			...
  			:models '(openai/lbl/cborg-chat:latest openai/lbl/cborg-coder:latest))))
#+END_SRC
* Divers
#+BEGIN_SRC emacs-lisp :tangle yes
